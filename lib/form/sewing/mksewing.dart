...
class _MekanikSewingState extends State<MekanikSewing> {
  ...
  List<ModelPersonal> _items = [];
  //List<Lokasi> _lokasi = [];
  ModelPersonal? _selectedTeknisi;
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        DropdownButtonFormField<ModelPersonal>(
                          value: _selectedTeknisi,
                          items: _items.map((ModelPersonal item) {
                            print(item);
                            return DropdownMenuItem<ModelPersonal>(
                                child: Text(item.nama), value: item);
                          }).toList(),
                          onChanged: (ModelPersonal? newValue) {
                            setState(() {
